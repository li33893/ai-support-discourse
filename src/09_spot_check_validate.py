...
WHAT THIS SCRIPT DOES:
    ...
    5. Reports PASS/FAIL against KAPPA_THRESHOLD and exports the summary table
...
FLOW:
    ...
    3. main()
       ...
       - 05: disagreement pairs per dimension
       - 06-07: results table and terminal summary
       - 08: export summary and disagreement CSVs
...
def main():
    ...
    # calculate correct_n, precision and recall for each category
    category_rows = []
    for d in DIMENSIONS:
    ...
    category_path = os.path.join(outputs_dir, "spot_check_category_performance.csv")
